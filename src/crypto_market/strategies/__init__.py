...
READINGS = {
    ...
    "playbook": "The spot half of Pavel Kycek's Algorithmic Crypto Playbook, from his public descriptions of it: simple rules "
                ...
                "day late it made 27%; by year +37, -17, +76, +57, +50, +1, against a basket that lost 74% in 2022. "
                "The author's own checks: neighbours -- every average from 30 to 75 days makes 37-54% held back and the "
                "five crossovers around 10/50 make 24-31%, so the fast settings are a plateau, but 100 and 200 days and "
                "the slow crossovers lose money, and the 44 variants averaged make 0%; dropping the 3 or 5 coins that "
                "contributed most changes nothing (34% and 33% held back), so no one coin carries it; re-choosing the "
                "picks each January from the years before chooses the same four every year and makes 46% a year over "
                "2023-2026 (+69, +57, +50, +2). What is left against it: the 12-hour and 4-hour versions make 1-3% a "
                "year held back against 28% for holding; the coins are the ones that survived to 2026, which the author "
                "says flatters this kind of test several times over and nothing here corrects; and no short selling or "
                "futures, so half of what he runs is missing. It is running forward on paper from 2026-09-06.",
}
